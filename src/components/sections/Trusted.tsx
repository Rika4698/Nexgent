        ...
        <div className="max-w-6xl mx-auto flex flex-col gap-4">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            >
              ...
              <h3 className="text-2xl font-medium text-gray-900 mb-3 mt-6">
                Calendar & Deadlines
              </h3>
              <p className="text-[#5D5D5D] text-lg tracking-tight font-medium">
          ...
          <div className="flex flex-col sm:flex-row gap-4">
            ...
            >
              ...
              <div className="mt-6">
                ...
                <p className="text-[#5D5D5D] text-lg font-medium tracking-tight">
