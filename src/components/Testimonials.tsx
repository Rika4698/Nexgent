...
export default function Testimonials() {
  ...
  return (
    <section className="bg-slate-100 font-sans py-12 sm:py-20 px-4 sm:px-6">
      <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-center gap-10 sm:gap-16">
        ...
        >
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-medium text-gray-900 leading-tight mb-4">
            What Our <span className="font-serif inline-block transform -skew-x-12 font-normal">Users Say</span>
          </h2>

          <p className="text-base sm:text-lg text-gray-500 leading-relaxed max-w-md font-normal tracking-tight">
        ...
        >
          <div className="bg-[#FFFFFF]  rounded-2xl p-5 sm:p-8 flex flex-col gap-6 min-h-[320px] sm:min-h-[420px]">
            <AnimatePresence mode="wait">
              <motion.p
                ...
                className="text-gray-800 text-xl font-medium leading-relaxed flex-1 tracking-wide"
              >
            ...
            <div className="flex items-center justify-between mt-auto">
              ...
              <div className="flex items-center gap-0 border border-gray-200 rounded-full overflow-hidden">
                ...
                <span className="px-3 text-sm text-gray-800 tracking-widest">
